...
document.getElementById('exportPDF').addEventListener('click', function() {
    ...
    if (typeof window.jspdf === "undefined") {
        console.error("Błąd: jsPDF nie został poprawnie załadowany.");
        alert("Błąd: jsPDF nie został poprawnie załadowany. Sprawdź połączenie internetowe.");
        return;
    }
...
// Ładowanie jsPDF poprawnie w GitHub Pages
window.onload = function() {
    console.log("Ładowanie skryptu jsPDF...");
